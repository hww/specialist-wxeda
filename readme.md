...
|---------------|-------------------|---------------------|
| 00 | VGA | |
| 10 | Компонентный YPbPr576p50 | **R**-Pr<br>**G**-Y<br>**B**-Pb _только при компиляции варианта по умолчанию, с VGA 50 Гц_ |
| 01 или 11 | Copmosite-Video и S-Video | **R**-Composite<br>**G**-Y_SVideo<br>**B**-С_SVideo) |
